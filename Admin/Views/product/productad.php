    ...
    <table class="table table-bordered" id="dataTable" width="100%" cellspacing="0">
       ...
       <?php foreach($data_product as $value){ ?>
                ...
                <td>
                    <div class="">
                    <a class="btn btn-success" href="/WebFood/Webfood?act=detail&sp=<?= $value['MaSP']?>">Xem</a>
                        <a href="?mod=sanpham&act=edit&idsp=<?= $value['MaSP']?>" class="btn btn-warning">Sửa</a>
                        <a href="?mod=sanpham&act=delete&idsp=<?= $value['MaSP']?>"  onclick="return confirm('Bạn có thật sự muốn xóa ?');" type="button" class="btn btn-danger">Xóa</a>
                    </div>
                </td>
            </tr>
        <?php   }?> 
