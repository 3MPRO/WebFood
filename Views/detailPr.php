    ...
    <div class="container">
        <div class="break-crumb">
            <div class="break-crumb__head">
                ...
                <div>
                    <strong>
                        <span>Chuối tiêu quê loại to</span>
                    </strong>
                </div>
            </div>
        </div>
        ...
        <div class="row mb-4">
            <div class="col col-lg-4">
                <div class="product-detail-left">
                    <div class="product-detail-left__thumbnail">
                        <img src="./images/pro20-grande.webp" alt="" class="product-detail-left__image-main">
                    </div>
                    <div class="product-detail-left__list-thumb">
                        <ul>
                            <li class="active"><img src="./images/pro20-grande.webp" alt=""></li>
                            <li><img src="./images/pro29-grande.jpg" alt=""></li>
                            <li><img src="./images/pro28-grande.jpg" alt=""></li>
                        </ul>
            ...
            <div class="col col-lg-3">
                <a href="" class="product-detail-banner">
                    <img src="./images/banner_detail.webp" alt="">
                </a>
            </div>
        </div>
        <div class="row mb-5">
                ...
                <div class="owl-carousel owl-theme" id="owl-slider-dry">
                    <div class="product-main">
                        <form action="">
                            <div class="product-fruits__thumb">
                                <a href="">
                                    <img src="./images/images-dry/sp26.jpg" alt="">
                                </a>
                    ...
                    <div class="product-main">
                        <form action="">
                            <div class="product-fruits__thumb">
                                <a href="">
                                    <img src="./images/images-dry/sp27.jpg" alt="">
                                </a>
                                <div class="icon-heart-product">
                                    <i class="far fa-heart"></i>
                                </div>
                    ...
                    <div class="product-main">
                        <form action="">
                            <div class="product-fruits__thumb">
                                <a href="">
                                    <img src="./images/images-dry/sp29.webp" alt="">
                                </a>
                                <div class="icon-heart-product">
                                    <i class="far fa-heart"></i>
                                </div>
            ...
            <div class="container">
                ...
                <div class="row mb-4">
                    <div class="col col-lg-4">
                        <div class="product-detail-left">
                            <div class="product-detail-left__thumbnail">
                                <img src="./public/images/pro20-grande.webp" alt="" class="product-detail-left__image-main">
                            </div>
                            <div class="product-detail-left__list-thumb">
                                <ul>
                                    <li class="active"><img src="./public/images/pro20-grande.webp" alt=""></li>
